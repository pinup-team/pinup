...
public class CommentApiController {
    ...
    @PostMapping("/{postId}")
    public ResponseEntity<CommentResponse> createComment(@AuthenticationPrincipal MemberInfo memberInfo, @PathVariable Long postId, @Valid @RequestBody CreateCommentRequest createCommentRequest) {
