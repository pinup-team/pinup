...
//    static WireMockExtension wireMockServer = WireMockExtension.newInstance().options(wireMockConfig().port(8888)).build();
    ...
    public OAuthTest(MockMvc mockMvc, UserService userService, OauthConfig oauthConfig) {
    ...
    class OAuthLoginTests {
        ...
        void naverLogin() throws Exception {
            ...
            UserInfo userInfo = UserInfo.builder()
                    ...
                    .build();
            given(userService.login(naverParams, eq(null))).willReturn(userInfo);
        ...
        void googleLogin() throws Exception {
            ...
            UserInfo userInfo = UserInfo.builder()
                    ...
                    .role(UserRole.ROLE_USER)
                    .build();
            given(userService.login(googleParams, eq(null))).willReturn(userInfo);
